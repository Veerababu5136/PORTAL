...
$query = "SELECT * FROM categories ORDER BY id ASC";  // Fetch from the 'categories' table
                          ...
                          while ($row = mysqli_fetch_assoc($query_runner)) {
                              echo "<tr>
                                      ...
                                      <td data-label='Action'>
                                          <a href='assignments.php?category_id={$row['id']}' class='btn btn-primary btn-sm'>Get Assignments</a>
                                      </td>
                                    </tr>";
                              $sno++;
                          }
